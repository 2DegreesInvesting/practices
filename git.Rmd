...
focuses on _what_ to do and _why_, and only recommends optional resources
about _how_ to do it. These practices:
...
* apply to shared commits^[A _shared_ commit is a commit that someone
other than you might access, for example, because you pushed it to a remote
repository that someone else has permission privileges to access.] (maybe
